            ...
            <form action="{{ route('reg.update', $Register->id) }}" method="POST">
                ...
                <fieldset>
                    ...
                    <select name="landmark">
                        ...
                        <optgroup label="北市">
                            <option value="tp01" {{ $Register->landmark == 'tp01' ? 'selected' : '' }}>北車</option>
                            <option value="tp02" {{ $Register->landmark == 'tp02' ? 'selected' : '' }}>北美館</option>
                            <option value="tp03" {{ $Register->landmark == 'tp03' ? 'selected' : '' }}>故宮</option>

                        </optgroup>
                        <optgroup label="高雄">
                            <option value="kh01" {{ $Register->landmark == 'kh01' ? 'selected' : '' }}>小港機場
                            </option>
                            <option value="kh02" {{ $Register->landmark == 'kh02' ? 'selected' : '' }}>旗津</option>
                            <option value="kh03" {{ $Register->landmark == 'kh03' ? 'selected' : '' }}>中山大學
                            </option>
                        </optgroup>
